...
export interface ApiTimelineTimeline extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    tzeets: Schema.Attribute.Relation<'oneToMany', 'api::tzeet.tzeet'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTzeetTzeet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    likes: Schema.Attribute.Integer &
      ...
      >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tzeet.tzeet'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    timeline: Schema.Attribute.Relation<'oneToOne', 'api::timeline.timeline'>;
    tzeets: Schema.Attribute.Relation<'oneToMany', 'api::tzeet.tzeet'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
